...
// in app_simples/test/helpers/test_helpers.dart.
...
import 'package:app_simples/data/datasources/post_remote_datasource.dart'
    as _i6;
import 'package:app_simples/data/models/post_model.dart' as _i7;
import 'package:app_simples/domain/entities/post.dart' as _i5;
import 'package:app_simples/domain/repositories/post_repository.dart' as _i3;
...
class MockPostRepository extends _i1.Mock implements _i3.PostRepository {
  ...
  @override
  _i4.Future<List<_i5.Post>> getPosts() => (super.noSuchMethod(
        Invocation.method(
          #getPosts,
          [],
        ),
...
class MockPostRemoteDataSource extends _i1.Mock
    implements _i6.PostRemoteDataSource {
  MockPostRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<_i7.PostModel>> getPosts() => (super.noSuchMethod(
        Invocation.method(
          #getPosts,
          [],
        ),
